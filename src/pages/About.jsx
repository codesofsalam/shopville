          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                At ShopVille, we&apos;re passionate about revolutionizing the
                online shopping experience. Our mission is to provide customers
                with high-quality products, exceptional service, and a seamless
                shopping journey.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Every decision we make puts our customers needs at the forefront.",
              },
              {
                title: "Innovation",
                description:
                  "We continuously evolve and adapt to provide the best shopping experience.",
              },
            ].map((value, index) => (
              <div
                key={index}
